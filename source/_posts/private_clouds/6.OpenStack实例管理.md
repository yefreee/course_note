...
2. 创建Nova数据库并授权
    ...
    2. 使用`CREATE DATABASE`命令新建“nova-api”，“nova_cell0”，“nova”三个数据库
...
4. 创建实例
    ...
    ```shell
    [root@controller ~]# openstack server create --flavor test_flavor --network test_net --key-name demo-pub --image cirros cirros-VM1
    ```
