...
3. 使用ohmyzsh提供的脚本配置zsh。
    ...
    ```shell
    [centos@localhost ~]$ sh -c "$(wget -O- --no-check-certificate https://drive.taojie.fun:52222/d/s/12CAWp17mvHt03RXkvtPQzMEPlw0EvnY/webapi/entry.cgi/SYNO.SynologyDrive.Files/install.sh?api=SYNO.SynologyDrive.Files&method=download&version=2&files=%5B%22id%3A869030700720893976%22%5D&force_download=true&json_error=true&download_type=%22download%22&c2_offload=%22allow%22&_dc=1739762217357&sharing_token=%22jz1Acg39gLaA9X3RqxhZEbQAFDFjmAtqhn4F68upbwDSvqfhFpZ.Gv8CR5XnZap6ZHVsnzrM08vwMOTKh8IYwyUp8Hz7wxH33zjET.8ovnbMLxOyeDq1TKisHX2GMpWVX0hElbV1BdRXYJadKqSGuPW1mxWvrcPQTNZDk3mN3ArUtF7t70lODauOmesBJ7xmr2lDBFKzfVR2dvh6DPFp05A1jbUo5dssgkzrAHtlFIZHI2ydQL6WebHP%22&SynoToken=3SiLgDWgOG3W2)"
    ```
