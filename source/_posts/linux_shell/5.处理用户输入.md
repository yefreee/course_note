...
启动该脚本时使用的完整参数 $0 为：/home/ubuntu/test.sh
```
...
root@localhost:~$ bash test.sh 1 2 3 4 5
...
>作业2：在上文第一个例子(阶乘脚本)的基础上完善以下参数检查相关的功能
...
>作业3：编写并执行以下脚本（重点：`shift` 参数处理与选项用法）：
